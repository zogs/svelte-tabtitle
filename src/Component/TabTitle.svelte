<script>
  ...
  export let borderColor = null; // Hex or rgba
...
<div class="booknote" on:click bind:this={container} style="height:{height}px">
  ...
  <div class="content" bind:this={content} class:left={align==='left'} class:right={align==='right'} style="transform: translateX(calc({contentTranslationX}% + {shiftX}px))">
    <slot>An exampe Booknote</slot>
  </div>
</div>

<style>
  div.booknote { width:100%; position:relative; }
